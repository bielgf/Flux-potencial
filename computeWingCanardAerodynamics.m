function [Cl_y_w, Cl_y_h, Cd_y_w, Cd_y_h, CM_loc] = computeWingCanardAerodynamics(gamma_w,gamma_h,alpha,cwi05,chi05,Qinf_mod,Cl0w,Cl0h,Claw,Clah,thetai05,i_h,rho,dy_w,dy_h,l_h,Cm14_w,Cm14_h)
