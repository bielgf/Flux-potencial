function plotCLandCM14vsalpha(alpha,CL_table,CM14_table)
    ...
    Clalpha = polyfit(rad2deg(alpha),CL_table(:,end),1);
    text(4,0.65,sprintf('C_{l_{\\alpha}} = %.4f',Clalpha(1)))
    ...
    Cmalpha = polyfit(rad2deg(alpha),CM14_table(:,end),1);
    text(4,-0.001,sprintf('C_{m_{\\alpha}} = %.4f',Cmalpha(1)))
